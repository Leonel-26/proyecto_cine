...
<header>
  ...
  <center>
    <div class="cartelera"><i class="fa fa-ticket" style="font-size:60px;color:rgb(170, 19, 19)"></i> <b>CONSULTA DE TICKETS</b></div>
  </center>
      <div class="container">
      <div class="row">
      <center><table class="table mt-3 table-striped table-bordered"></center>
  <thead class="table-warning">
    <tr>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">NOMBRES</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">APELLIDOS</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">CÉDULA</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">EDAD</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">CIUDAD</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">PELÍCULA</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">FECHA</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">TIPO DE SALA</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">Nº ASIENTOS</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">ASIENTOS SELEC.</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">PRECIO</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">FORMA DE PAGO</center></th>
      <th scope="col"><center style="font-family:cursive; font-size: 15px;color:rgb(170, 19, 19)">TOTAL</center></th>
    </tr>
  </thead>
              ...
              while ($ver = mysqli_fetch_assoc($result))
              {
                 ?>
                   <tr>
                        ...
                        <td> <?= $ver["ciudad"]?> </td>
                        <td> <?= $ver["pelicula"]?> </td>
                        <td> <?= $ver["fecha_reser"]?> </td>
                        <td> <?= $ver["sala"]?> </td>
                        <td> <?= $ver["asientos"]?> </td>
                        <td> <?= $ver["asientosSel"]?> </td>
                        <td> <?= $ver["precio"]?> </td>
                        <td> <?= $ver["fpago"]?> </td>
                        <td> <?= $ver["total"]?> </td>
                    </tr>   
