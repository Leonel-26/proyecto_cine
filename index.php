...
<header>
    <nav>
      ...
      <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="responsive carousel-inner">
          <div class="responsive carousel-item active">
            <center><img src="img/img1.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
          <div class="responsive carousel-item">
            <center><img src="img/img2.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
          <div class="carousel-item">
            <center><img src="img/img3.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
          <div class="carousel-item">
            <center><img src="img/img4.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
          <div class="carousel-item">
            <center><img src="img/img5.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
          <div class="carousel-item">
            <center><img src="img/img6.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
          <div class="carousel-item">
            <center><img src="img/img7.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
          <div class="carousel-item">
            <center><img src="img/img8.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
          <div class="carousel-item">
            <center><img src="img/img9.jpg" id="slide" alt=" " width="800" height="400" class="d-block"
                style="width:50%"></center>
          </div>
        </div>
