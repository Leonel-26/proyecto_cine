...
<header>
    <nav>
      ...
      <center><div class="cartelera"><i class="fas fa-film" style="font-size:60px;color:rgb(170, 19, 19)"></i> <b>¿DÓNDE ESTAMOS?</b></div></center>
      <br>
      <div class="peli1">
        <div class="row">
           <div class="col-2">
            <center><img src="img/estamos.png" alt="" width="600px" height="400px"></center>
           </div>
           <div class="col-2">
            <center><FONT color="white"><h3><p class="parrafo" style= "background-color: gray" id="parrafo1"> <br>
              JIPICINE
              <br>         
              <br>    
               Provincia Manabí, Cantón Jipijapa.
               <br>
               <br>
               Calle 5 de abril.
               <br>
               <br>
               Avenida Universitaria.</p></h3></FONT></center>
           </div>
        </div>
     </div>
     <footer>
