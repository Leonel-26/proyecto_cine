...
<header>
    <nav>
        ...
        <center><div class="cartelera"><i class="fas fa-user" style="font-size:60px;color:rgb(170, 19, 19)"></i> <b>INICIAR SESIÓN</b></div></center>
       <br>

      <form name="form1" method="post" action="cinee.php" class="form1">
      <center><table width="319" height="82" style = "font-size:20px"></center>
        ...
        <tr>
          ...
          <td><input class="btn btn-warning" style="color: black; background-color:rgb(170, 19, 19); font-size: 20px; padding:10px; margin:30px" type="submit" name="Submit" value="INGRESAR" id="submit"></td>
