...
<header>
    <nav>
        ...
        <center><div class="cartelera"><i class="fas fa-book-dead" style="font-size:60px;color:rgb(170, 19, 19)"></i><b> EL CUARTO 666</b></div></center>
      <div class="peli1">
      <a href="peli4.php"><img src="img/peli4.jpg" alt="" width="400px" height="385px"></a>
      <div class="p1" style= "background-color: black"><center><FONT color="white" class="p1"><h2><b>EL CUARTO 666</b></h2></FONT></center></div>
    <center><FONT color="white"><h3><p class="parrafo" style= "background-color: rgba(128, 128, 128, 0.192)" id="parrafo1">Bianca es contratada 
    para trabajar en un turno de noche en una clínica pediátrica. Pronto descubre que el instituto esconde un terrorífico secreto vinculado
    a su pasado como hospital psiquiátrico. El fantasma de un niño durmiendo en la cama no. 6, deambula por los pasillos burlándose de Bianca,
    quien comienza a perder la cabeza. Su única salida es descubrir qué le sucedió al niño muchos años antes.</p></h3></FONT></center>
        </div>
          <table align="center" border="3" class="video" bgcolor="rgb(170, 19, 19)">
      <tr>
      <td><iframe width="700" height="400" src="https://www.youtube.com/embed/5SPkWITwMFk" title="YouTube video player" frameborder="0" 
