...
<header>
    <nav>
        ...
        <center><div class="cartelera"><i class="fas fa-user-astronaut" style="font-size:60px;color:rgb(170, 19, 19)"></i><b> LIGHT YEAR</b></div></center>
      <div class="peli1">
      <a href="peli2.php"><img src="img/peli2.jpg" alt="" width="400px" height="385px"></a>
      <div class="p1" style= "background-color: black;"><center><FONT color="white" class="p1"><h2><b>LIGHT YEAR</b></h2></FONT></center></div>
    <center><FONT color="white"><h3><p class="parrafo" style= "background-color:rgba(128, 128, 128, 0.192)" id="parrafo1">Esta nueva precuela de 
    la saga Toy Story, se centra en la figura de uno de sus protagonistas, Buzz Lightyear. Pero, en esta ocasión, no se centra en el popular
    muñeco articulado, sino en el piloto humano en el que estaba inspirado el juguete. Chris Evans volverá a ser la voz de este popular 
    astronauta en su versión original.</p></h3></FONT></center>
        </div>
          <table align="center" border="3" class="video" bgcolor="rgb(170, 19, 19)">
      <tr>
      <td><iframe width="700" height="400" src="https://www.youtube.com/embed/85RKZuoAz7c" title="YouTube video player" frameborder="0" 
