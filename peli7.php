...
<header>
    <nav>
        ...
        <center><div class="cartelera"><i class="fas fa-skull-crossbones" style="font-size:60px;color:rgb(170, 19, 19)"></i><b> INVOCANDO AL DEMONIO</b></div></center>
      <div class="peli1">
      <a href="peli7.php"><img src="img/peli7.jpg" alt="" width="400px" height="385px"></a>
      <div class="p1" style= "background-color: black"><center><FONT color="white" class="p1"><h2><b>INVOCANDO AL DEMONIO</b></h2></FONT></center></div>
    <center><FONT color="white"><h3><p class="parrafo" style= "background-color: rgba(128, 128, 128, 0.192)" id="parrafo1">Vacaciones de verano. 
      Tres chicas, que han sido inseparables desde niñas, invocan el espíritu de Kandisha, una criatura vengativa e inquietante que se 
      encuentra en las leyendas marroquíes. Lo que solo pretendía ser un juego se convierte en una pesadilla cuando las relaciones cercanas
       del trío comienzan a desaparecer en circunstancias cada vez más trágicas.</p></h3></FONT></center>
        </div>
          <table align="center" border="3" class="video" bgcolor="rgb(170, 19, 19)">
      <tr>
      <td><iframe width="700" height="400" src="https://www.youtube.com/embed/d8nX5Ucm2_E" title="YouTube video player" frameborder="0" 
