...
<header>
    <nav>
        ...
        <center><div class="cartelera"><i class="fa fa-music" style="font-size:60px;color:rgb(170, 19, 19)"></i><b> ELVIS</b></div></center>
      <div class="peli1">
      <a href="peli8.php"><img src="img/peli8.jpg" alt="" width="400px" height="385px"></a>
      <div class="p1" style= "background-color: black"><center><FONT color="white" class="p1"><h2><b>ELVIS</b></h2></FONT></center></div>
    <center><FONT color="white"><h3><p class="parrafo" style= "background-color: rgba(128, 128, 128, 0.192)" id="parrafo1">Filme biográfico en torno
    a la vida y la música de Elvis Presley (Austin Butler), enfocadas de su compleja relación con su misterioso agente: el coronel Tom Parker
    (Hanks). La película ahonda en la complicada dinámica entre Presley y Parker a lo largo de más de 20 años, desde el ascenso a la fama de
    Presley hasta su estrellato sin precedentes. Todo ello tras el telón de la evolución cultural y la madurez social en Estados Unidos. En 
    el centro de ese viaje está una de las personas más importantes e influyentes en la vida de Elvis, Priscilla Presley (Olivia DeJonge).</p>
    </h3></FONT></center>
        </div>
          <table align="center" border="3" class="video" bgcolor="rgb(170, 19, 19)">
      <tr>
      <td><iframe width="700" height="400" src="https://www.youtube.com/embed/JoqmHAr3fu8" title="YouTube video player" frameborder="0" 
