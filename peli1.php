...
<header>
    <nav>
        ...
        <center><div class="cartelera"><i class="fas fa-dragon" style="font-size:60px;color:rgb(170, 19, 19)"></i><b> JURASSIC WORLD</b></div></center>
      <div class="peli1">
      <a href="peli1.php"><img src="img/peli1.jpg" alt="" width="400px" height="385px"></a>
      <div class="p1" style= "background-color: black"><center><FONT color="white" class="p1"><h2><b>JURASSIC WORLD</b></h2></FONT></center></div>
    <center><FONT color="white"><h3><p class="parrafo" style= "background-color: rgba(128, 128, 128, 0.192)" id="parrafo1">Cuatro años después de la destrucción de Isla Nublar, los dinosaurios ahora viven y cazan junto a los humanos en todo el mundo. 
          Este frágil equilibrio remodelará el futuro y determinará, de una vez por todas, si los seres humanos seguirán siendo los 
          depredadores máximos en un planeta que ahora comparten con las criaturas más temibles de la historia.</p></h3></FONT></center>
        </div>
          <table align="center" border="3" class="video" bgcolor="rgb(170, 19, 19)">
      <tr>
      <td><iframe width="700" height="400" src="https://www.youtube.com/embed/qehG9dKVDG4" title="YouTube video player" 
