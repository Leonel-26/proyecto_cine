...
<header>
    <nav>
        ...
        <center><div class="cartelera"><i class="fas fa-dog" style="font-size:60px;color:rgb(170, 19, 19)"></i><b> DOG: UN VIAJE SALVAJE</b></div></center>
      <div class="peli1">
      <a href="peli9.php"><img src="img/peli9.jpg" alt="" width="400px" height="385px"></a>
      <div class="p1" style= "background-color: black"><center><FONT color="white" class="p1"><h2><b>DOG: UN VIAJE SALVAJE</b></h2></FONT></center></div>
    <center><FONT color="white"><h3><p class="parrafo" style= "background-color: rgba(128, 128, 128, 0.192)" id="parrafo1">Jackson Briggs 
    (Channing Tatum), un ex ranger del ejército que se aventurará a cruzar el país junto a Lulú. Ambos recorrerán la costa del Pacífico con la
    esperanza de llegar a tiempo al funeral de su mejor amigo. Juntos, se volverán locos el uno al otro, romperán algunas reglas, aprenderán
    cómo amar y tendrán la posibilidad de crear una nueva vida.</p></h3></FONT></center>
        </div>
          <table align="center" border="3" class="video" bgcolor="rgb(170, 19, 19)">
      <tr>
      <td><iframe width="700" height="400" src="https://www.youtube.com/embed/7ZdW_JgIkcU" title="YouTube video player" frameborder="0" 
